...
export function NavBetaBadge({ style }: { style?: CSSProperties }) {
  return (
    <span
      style={style}
      className="pointer-events-none inline-flex items-center rounded-full border border-violet-500/30 bg-gradient-to-r from-violet-500/15 via-fuchsia-500/15 to-amber-500/10 px-1 py-px text-[11px] font-semibold uppercase leading-3 tracking-wider text-violet-600 dark:text-violet-300"
      title="Beta 功能"
    >
      Beta
    </span>
